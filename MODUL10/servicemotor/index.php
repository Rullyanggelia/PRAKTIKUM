...
<td>
<a class="edit" href="edit.php?Tgl Transaksi=<?php echo $tampil['Tgl Transaksi']; ?>">Edit</a> |
<a class="hapus" href="hapus.php?Tgl Transaksi=<?php echo $tampil['Tgl Transaksi']; ?>">Hapus</a>
</td>
</tr>
<?php } ?>
</table>
