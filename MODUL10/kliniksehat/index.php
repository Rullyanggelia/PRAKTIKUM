...
?>
<tr>
    <td><?php echo $tampil['No_Pasien']; ?></td>
    ...
    <td>
        <a class="edit" href="edit.php?No_Pasien=<?php echo $tampil['No_Pasien']; ?>">Edit</a> |
        <a class="hapus" href="hapus.php?No_Pasien=<?php echo $tampil['No_Pasien']; ?>">Hapus</a>
    </td>
</tr>
<?php } ?>
</table>
