    ...
    <body>
        <form method="post">
            <table>
                ...
                <tr>
                    ...
                    <td>:</td>
                    <td>
                        <input type="adio" name="jk" value="Laki-Laki"/>Laki-Laki<br/>
                        <input type="adio" name="jk" value="Perempuan"/>Perempuan
                    </td>
                </tr>
                <tr>
                    <td>Email</td>
        ...
        <?php
            if(isset($_POST['submit'])){
                ...
                echo "INI OUTPUT SESUAI INPUTANDARI FORM DIATAS <br/>";
                echo "Nama : " . $nama;
